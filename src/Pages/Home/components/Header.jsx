...
const Header = () => {
    return (
        <div className="grid grid-cols-10 gap-5 container mx-auto my-5 md:my-10 px-3 md:px-0">
            ...
            <div className="header-image order-1 md:order-2 col-span-10 md:col-span-6 rounded-3xl md:rounded-[100px]">
                <div className="w-full h-full bg-black bg-opacity-50 text-white text-center header-title md:py-16 py-10 lg:py-28 xl:py-36 px-10 md:p-12 lg:p-20 text-3xl sm:text-6xl rounded-3xl md:rounded-[100px]">
