...
const AddedFood = ({ addedFood }) => {
    ...
    return (
        <div className="border-4 rounded-3xl p-3 gap-3 sm:gap-10 flex items-center justify-between">
            <img className="w-10 sm:w-14 rounded-md md:w-24 md:rounded-2xl" src={image} alt="" />
            <h3 className="flex-1 text-base sm:text-xl md:text-3xl font-semibold">{foodName}</h3>
